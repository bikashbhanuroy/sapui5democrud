		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "CRUD with Northwind",
									"targetURL": "#nwsapui5democrud-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nwsapui5democrud-display": {
								"semanticObject": "nwsapui5democrud",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nw.sapui5democrud",
									"url": sap.ui.require.toUrl("nw/sapui5democrud")
								}
							}
						}
					}
